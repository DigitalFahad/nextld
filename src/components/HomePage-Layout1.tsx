...
const HomePageLayout1 = () => {
  const coreServices = [
    ...
    },
    {
      ...
      description: "Advanced SEO strategies with AI insights for global visibility",
      highlight: "Top 3 rankings guaranteed",
      color: "from-blue-500 to-cyan-600"
    },
    {
      icon: Code,
      title: "Website Development",
      description: "Custom WordPress & Shopify solutions for international markets",
    ...
    },
    {
      icon: Palette,
      title: "UI/UX Design",
      description: "Conversion-optimized designs that speak to global audiences",
      highlight: "85% conversion boost",
  ...
  const timeZones = [
    { zone: "EST", time: "9:00 AM" },
    { zone: "GMT", time: "2:00 PM" },
    { zone: "AEST", time: "1:00 AM+1" },
    { zone: "GST", time: "6:00 PM" }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-navy-900 mb-6 leading-tight">
                Scale Your Business
                <span className="gradient-text block">Globally</span>
              </h1>

              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Premium digital solutions trusted by businesses across USA, UK, Australia, 
                and the Middle East. Led by Fahad Khalil, we combine AI innovation with 
                proven strategies to deliver exceptional results.
              </p>

              {/* International Credibility */}
              <div className="bg-white rounded-2xl p-6 shadow-lg border mb-8">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-navy-900">Available Across Time Zones</h3>
                  <Clock className="w-5 h-5 text-blue-500" />
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {timeZones.map((tz) => (
                    <div key={tz.zone} className="text-center">
                      <div className="text-sm font-medium text-gray-600">{tz.zone}</div>
                      <div className="text-xs text-gray-500">{tz.time}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="w-full h-96 bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl flex items-center justify-center mb-6 relative">
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-lg font-medium">Fahad Khalil</p>
                    <p className="text-sm">Global Digital Strategist</p>
                    <p className="text-xs mt-2 opacity-75">Professional photo from Singapore tech summit</p>
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Strategic services designed for ambitious businesses ready to dominate global markets
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry expertise backed by real results for businesses worldwide
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center p-8 border-0 shadow-lg">
              ...
              <h3 className="text-3xl font-bold text-navy-900 mb-2">300%</h3>
              <p className="text-gray-600 mb-4">Average ROI Increase</p>
              <p className="text-sm text-gray-500">Across performance marketing campaigns</p>
            </Card>
            ...
            <Card className="text-center p-8 border-0 shadow-lg">
              ...
              <h3 className="text-3xl font-bold text-navy-900 mb-2">95%</h3>
              <p className="text-gray-600 mb-4">Top 3 Search Rankings</p>
              <p className="text-sm text-gray-500">Within 6 months for competitive keywords</p>
            </Card>
            ...
            <Card className="text-center p-8 border-0 shadow-lg">
              ...
              <h3 className="text-3xl font-bold text-navy-900 mb-2">50+</h3>
              <p className="text-gray-600 mb-4">Global Brands Served</p>
              <p className="text-sm text-gray-500">From startups to Fortune 500 companies</p>
            </Card>
          </div>
        </div>
      </section>

      {/* About Fahad - Authority Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                Fahad Khalil brings 8+ years of digital expertise, having spoken at global 
                conferences and advised businesses across 15+ countries on scaling through 
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span>Featured speaker at Singapore Tech Summit 2024</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span>Certified in Google, Meta, and HubSpot platforms</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span>Strategic advisor to 50+ international businesses</span>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center">
                <div className="text-center text-gray-400">
                  ...
                  <p className="text-sm">At Global Conference</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Book your free 30-minute strategy session and discover how we can 
            accelerate your business growth in international markets.
          </p>
          ...
          <p className="text-sm opacity-75">
            ✓ No commitment required ✓ Results-focused consultation ✓ International expertise
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Global digital excellence, delivered with precision and passion.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-300">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Karachi | Singapore | Remote</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Clock className="w-4 h-4" />
                  <span>Available 24/7 Across Time Zones</span>
                </div>
              </div>
            </div>
